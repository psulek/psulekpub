...
namespace TimeSync
{
    ...
    public class NTPClient
    {
        ...
        private void Connect(bool UpdateSystemTime)
		{
			try {
		...
		public override string ToString()
		{
            ...
            str += "\r\nLocal time: " + TransmitTimestamp.ToString() + "." + TransmitTimestamp.Millisecond;
            ...
            str += "\r\nLocal time updated to: " + NewUpdatedTime.ToString("dd.MM.yyyy HH:mm:ss.") + NewUpdatedTime.Millisecond;
			str += "\r\n";
        ...
        {
            NewUpdatedTime = SetSystemTime(TransmitTimestamp);
        }


        public static DateTime SetSystemTime(DateTime input)
		{
			SYSTEMTIME st;
        ...
        public DateTime NewUpdatedTime { get; set; }
